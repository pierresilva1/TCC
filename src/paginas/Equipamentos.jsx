  ...
  return (
    ...
    <main className="equipamentos">
        ...
        <Peltier_Modal isOpen={openPeltier_Modal} setPeltier_ModalOpen={() => setPeltier_ModalOpen(!openPeltier_Modal)}>
                ...
                <br />
                <button><a href="https://www.eletrogate.com/pastilha-termoeletrica-peltier-tec1-12706" className="amodals"><img src={compre} alt="" /></a></button>
                </div>
                <br />
            </Peltier_Modal>
            <Rele_Modal isOpen={openRele_Modal} setRele_ModalOpen={() => setRele_ModalOpen(!openRele_Modal)}>
                ...
                <br />
                <button><a href="https://www.eletrogate.com/modulo-rele-2-canais-5v-10a-com-borne-kr" className="amodals"><img src={compre} alt="" /></a></button>
                </div>
                <br />
            </Rele_Modal>
            <P4kre_Modal isOpen={openP4kre_Modal} setP4kre_ModalOpen={() => setP4kre_ModalOpen(!openP4kre_Modal)}>
                ...
                <br />
                <button><a href="https://www.eletrogate.com/conector-adaptador-plug-p4-femea-com-borne" className="amodals"><img src={compre} alt="" /></a></button>
                </div>
                <br />
            </P4kre_Modal>
            ...
            <Fonte_Modal isOpen={openFonte_Modal} setFonte_ModalOpen={() => setFonte_ModalOpen(!openFonte_Modal)}>
                ...
                <br />
                <button><a href="https://produto.mercadolivre.com.br/MLB-2831517951-fonte-12v-1a-bivolt-pcftv-fita-barra-de-led-_JM#is_advertising=true&position=2&search_layout=stack&type=pad&tracking_id=05f01d85-065d-472c-bbb0-0bfdc220ca83&is_advertising=true&ad_domain=VQCATCORE_LST&ad_position=2&ad_click_id=NzlkNmM3NDYtNTI1OC00OTU0LTkyMzItNDk0NzU4YjUwMzQ1" className="amodals"><img src={compre} alt="" /></a></button>
                </div>
                <br />
            </Fonte_Modal>
            <Interruptor_Modal isOpen={openInterruptor_Modal} setInterruptor_ModalOpen={() => setInterruptor_ModalOpen(!openInterruptor_Modal)}>
                ...
                <br />
                 <button><a href="https://www.eletrogate.com/chave-gangorra-com-2-terminais" className="amodals"><img src={compre} alt="" /></a></button>
                </div>
                <br />
            </Interruptor_Modal>
        </section>
